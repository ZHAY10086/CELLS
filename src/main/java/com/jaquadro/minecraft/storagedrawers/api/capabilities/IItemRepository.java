...
public interface IItemRepository
{
    ...
    /**
     * No-op capability storage for {@link net.minecraftforge.common.capabilities.CapabilityManager} registration.
     * IItemRepository state is managed by the implementing tile, not by the capability system.
     */
    class NullStorage implements Capability.IStorage<IItemRepository> {
        @Nullable
        @Override
    ...
    /**
     * Default no-op implementation for {@link net.minecraftforge.common.capabilities.CapabilityManager} registration.
     */
    class NullImpl implements IItemRepository {
        @Nonnull
        @Override
