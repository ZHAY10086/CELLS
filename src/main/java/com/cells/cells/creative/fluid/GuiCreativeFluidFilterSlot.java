...
/**
 * GUI widget for rendering fluid filter slots in the Creative Fluid Cell GUI.
 * <p>
 * Reads from the tank adapter directly.
 ...
 */
public class GuiCreativeFluidFilterSlot extends GuiCustomSlot implements IJEITargetSlot {
    ...
    /**
     * Get the actual slot index in the filter inventory.
     */
    public int getSlot() {
        return this.slot;
    }
    ...
    public IAEFluidStack getFluidStack() {
        return this.tankAdapter.getFluidInSlot(this.slot);
    }
