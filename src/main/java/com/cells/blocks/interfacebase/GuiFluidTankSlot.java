...
public class GuiFluidTankSlot extends GuiCustomSlot {
    ...
    public String getMessage() {
        ...
        String tooltipKey = this.isExport
            ? "tooltip.cells.fluid_export_interface.amount"
            : "tooltip.cells.fluid_import_interface.amount";

        return fluid.getLocalizedName() + "\n" + I18n.format(tooltipKey, fluid.amount, capacity);
    }
