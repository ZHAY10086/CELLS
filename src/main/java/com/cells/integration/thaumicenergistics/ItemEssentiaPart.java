...
/**
 * Item for CELLS essentia parts. Uses damage values to distinguish between part types.
 * Registered only when ThaumicEnergistics is loaded.
 * <p>
 * <b>Note:</b> Essentia parts do NOT participate in the Thaumcraft tube network.
 * Use the block versions if tube connectivity is required.
 */
public class ItemEssentiaPart extends Item implements IPartItem<IPart> {

    public ItemEssentiaPart() {
        this.setRegistryName(Tags.MODID, "essentia_part");
        this.setTranslationKey(Tags.MODID + ".part.essentia");
    ...
    public String getTranslationKey(ItemStack stack) {
        ...
        return "item." + Tags.MODID + ".part.essentia.invalid";
    }
    ...
    public IPart createPartFromItemStack(ItemStack stack) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to create essentia part from stack: " + stack, e);
        }
    }
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World world, @Nonnull List<String> tooltip,
        ...
        CellsEssentiaPartType type = CellsEssentiaPartType.getById(stack.getItemDamage());
        if (type != null && type.getTooltipKey() != null) tooltip.add(I18n.format(type.getTooltipKey()));
    ...
    public void registerModels() {
        for (CellsEssentiaPartType type : CellsEssentiaPartType.values()) {
            ...
            if (!models.isEmpty()) {
                ModelLoader.setCustomModelResourceLocation(this, type.getBaseDamage(), models.get(0));
            }
        }
    }
}
